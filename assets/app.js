...
(function () {
  ...
  function haxtunCrest() {
    return el("div", {
      class: "crest",
      html: '<svg class="haxtun-crest" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Haxtun Bulldogs"><defs><path id="topArc" d="M 38,110 A 72,72 0 0,1 182,110" fill="none"/><path id="botArc" d="M 182,110 A 72,72 0 0,1 38,110" fill="none"/></defs><circle cx="110" cy="110" r="104" fill="#ffffff" stroke="#c8102e" stroke-width="5"/><circle cx="110" cy="110" r="88" fill="none" stroke="#c8102e" stroke-width="1.5"/><circle cx="22" cy="110" r="3.5" fill="#c8102e"/><circle cx="198" cy="110" r="3.5" fill="#c8102e"/><text font-family="Inter, -apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="17" letter-spacing="6" fill="#111"><textPath href="#topArc" startOffset="50%" text-anchor="middle">HAXTUN</textPath></text><text font-family="Inter, -apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="17" letter-spacing="6" fill="#111"><textPath href="#botArc" startOffset="50%" text-anchor="middle">BULLDOGS</textPath></text><g transform="translate(0,-6)"><path d="M 70,82 L 76,62 L 92,80 Z" fill="#c8102e"/><path d="M 150,82 L 144,62 L 128,80 Z" fill="#c8102e"/><path d="M 68,95 C 68,80 80,72 95,72 L 125,72 C 140,72 152,80 152,95 L 152,120 C 152,140 138,152 118,154 L 102,154 C 82,152 68,140 68,120 Z" fill="#c8102e"/><ellipse cx="110" cy="138" rx="26" ry="16" fill="#c8102e"/><path d="M 100,88 L 110,80 L 120,88" stroke="#8a0a1f" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/><ellipse cx="93" cy="102" rx="7" ry="5" fill="#ffffff"/><ellipse cx="127" cy="102" rx="7" ry="5" fill="#ffffff"/><circle cx="94" cy="102" r="2.5" fill="#111111"/><circle cx="128" cy="102" r="2.5" fill="#111111"/><ellipse cx="110" cy="130" rx="7" ry="5" fill="#111111"/><path d="M 95,144 Q 110,152 125,144" stroke="#111111" stroke-width="2.5" fill="none" stroke-linecap="round"/><rect x="103" y="145" width="3.5" height="5" rx="1" fill="#ffffff"/><rect x="113.5" y="145" width="3.5" height="5" rx="1" fill="#ffffff"/></g></svg>',
    });
  }
