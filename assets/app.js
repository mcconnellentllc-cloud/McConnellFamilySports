...
(function () {
  ...
  // An original crest drawn for this family — not a historical grant, and not
  // a surname "coat of arms" bought off a heraldry site. Six stars for six
  // kids, a bound wheat sheaf over plowed ground, and a motto.
  function familyShield() {
    return el("div", { class: "crest crest--shield", html: '<svg class="crest-shield" viewBox="0 0 240 272" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="McConnell family crest: six stars for six children over a wheat sheaf and plowed ground, motto Rooted and Rising"><defs><clipPath id="shieldClip"><path d="M120 22 L208 22 L208 118 Q208 190 120 228 Q32 190 32 118 L32 22 Z"/></clipPath></defs><path d="M120 22 L208 22 L208 118 Q208 190 120 228 Q32 190 32 118 L32 22 Z" fill="#fffdf9" stroke="#c8102e" stroke-width="4"/><path d="M120 22 L208 22 L208 72 L32 72 L32 22 Z" fill="#c8102e"/><polygon points="54.0,39.0 52.0,44.3 46.4,44.5 50.8,48.0 49.3,53.5 54.0,50.4 58.7,53.5 57.2,48.0 61.6,44.5 56.0,44.3" fill="#fff"/><polygon points="80.4,39.0 78.4,44.3 72.8,44.5 77.2,48.0 75.7,53.5 80.4,50.4 85.1,53.5 83.6,48.0 88.0,44.5 82.4,44.3" fill="#fff"/><polygon points="106.8,39.0 104.8,44.3 99.2,44.5 103.6,48.0 102.1,53.5 106.8,50.4 111.5,53.5 110.0,48.0 114.4,44.5 108.8,44.3" fill="#fff"/><polygon points="133.2,39.0 131.2,44.3 125.6,44.5 130.0,48.0 128.5,53.5 133.2,50.4 137.9,53.5 136.4,48.0 140.8,44.5 135.2,44.3" fill="#fff"/><polygon points="159.6,39.0 157.6,44.3 152.0,44.5 156.4,48.0 154.9,53.5 159.6,50.4 164.3,53.5 162.8,48.0 167.2,44.5 161.6,44.3" fill="#fff"/><polygon points="186.0,39.0 184.0,44.3 178.4,44.5 182.8,48.0 181.3,53.5 186.0,50.4 190.7,53.5 189.2,48.0 193.6,44.5 188.0,44.3" fill="#fff"/><g clip-path="url(#shieldClip)"><path d="M20,194 H220" stroke="#4a4a4a" stroke-width="2.6" opacity="0.4" stroke-linecap="round"/><path d="M20,205 H220" stroke="#4a4a4a" stroke-width="2.6" opacity="0.4" stroke-linecap="round"/></g><path d="M120,178 Q120,145 120,118" stroke="#c9a227" stroke-width="2.4" fill="none" stroke-linecap="round"/><ellipse cx="124.2" cy="155.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(28 124.2 155.2)"/><ellipse cx="115.8" cy="149.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-28 115.8 149.2)"/><ellipse cx="124.2" cy="143.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(28 124.2 143.2)"/><ellipse cx="115.8" cy="137.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-28 115.8 137.2)"/><ellipse cx="124.2" cy="131.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(28 124.2 131.2)"/><ellipse cx="115.8" cy="125.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-28 115.8 125.2)"/><ellipse cx="124.2" cy="119.2" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(28 124.2 119.2)"/><ellipse cx="120" cy="115" rx="3.1" ry="6.6" fill="#daa520" transform="rotate(0 120 115)"/><path d="M120,178 Q113,148 98,124" stroke="#c9a227" stroke-width="2.4" fill="none" stroke-linecap="round"/><ellipse cx="117.3" cy="157.5" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(13 117.3 157.5)"/><ellipse cx="106.7" cy="152.1" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-43 106.7 152.1)"/><ellipse cx="112.8" cy="146.7" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(13 112.8 146.7)"/><ellipse cx="102.0" cy="141.3" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-43 102.0 141.3)"/><ellipse cx="107.9" cy="135.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(13 107.9 135.9)"/><ellipse cx="96.9" cy="130.5" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-43 96.9 130.5)"/><ellipse cx="102.7" cy="125.1" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(13 102.7 125.1)"/><ellipse cx="98" cy="121" rx="3.1" ry="6.6" fill="#daa520" transform="rotate(-20 98 121)"/><path d="M120,178 Q127,148 142,124" stroke="#c9a227" stroke-width="2.4" fill="none" stroke-linecap="round"/><ellipse cx="131.1" cy="157.5" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(43 131.1 157.5)"/><ellipse cx="124.9" cy="152.1" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-13 124.9 152.1)"/><ellipse cx="135.6" cy="146.7" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(43 135.6 146.7)"/><ellipse cx="129.6" cy="141.3" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-13 129.6 141.3)"/><ellipse cx="140.5" cy="135.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(43 140.5 135.9)"/><ellipse cx="134.7" cy="130.5" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-13 134.7 130.5)"/><ellipse cx="145.7" cy="125.1" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(43 145.7 125.1)"/><ellipse cx="142" cy="121" rx="3.1" ry="6.6" fill="#daa520" transform="rotate(20 142 121)"/><path d="M120,178 Q108,153 80,133" stroke="#c9a227" stroke-width="2.4" fill="none" stroke-linecap="round"/><ellipse cx="111.7" cy="160.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 111.7 160.9)"/><ellipse cx="99.2" cy="156.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-56 99.2 156.4)"/><ellipse cx="103.4" cy="151.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 103.4 151.9)"/><ellipse cx="90.6" cy="147.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-56 90.6 147.4)"/><ellipse cx="94.5" cy="142.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 94.5 142.9)"/><ellipse cx="81.5" cy="138.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(-56 81.5 138.4)"/><ellipse cx="85.2" cy="133.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 85.2 133.9)"/><ellipse cx="80" cy="130" rx="3.1" ry="6.6" fill="#daa520" transform="rotate(-36 80 130)"/><path d="M120,178 Q132,153 160,133" stroke="#c9a227" stroke-width="2.4" fill="none" stroke-linecap="round"/><ellipse cx="136.7" cy="160.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(56 136.7 160.9)"/><ellipse cx="132.4" cy="156.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 132.4 156.4)"/><ellipse cx="145.0" cy="151.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(56 145.0 151.9)"/><ellipse cx="141.0" cy="147.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 141.0 147.4)"/><ellipse cx="153.9" cy="142.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(56 153.9 142.9)"/><ellipse cx="150.1" cy="138.4" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(0 150.1 138.4)"/><ellipse cx="163.2" cy="133.9" rx="3.1" ry="6.4" fill="#daa520" transform="rotate(56 163.2 133.9)"/><ellipse cx="160" cy="130" rx="3.1" ry="6.6" fill="#daa520" transform="rotate(36 160 130)"/><rect x="103" y="166" width="34" height="10" rx="3" fill="#c8102e"/><path d="M34,239 H206 L224,252 L206,265 H34 L16,252 Z" fill="#c8102e"/><text x="120" y="257" text-anchor="middle" font-family="Cormorant Garamond, Georgia, serif" font-size="15" font-weight="600" letter-spacing="1.5" fill="#fff">ROOTED AND RISING</text></svg>' });
  }
